...
// Script.js
function initTableSorter(){$.tablesorter.addParser({id:"star_scores",is:function(){return!1},format:function(t,a,e,r){var o=$(e);return 1===r?o.attr("data-score")||t:t},parsed:!1,type:"numeric"}),$("table").tablesorter({headers:{1:{sorter:"star_scores"}},sortList:[[0,0]]})}$(document).ready(function(){window.chrome&&"file:"===window.location.protocol&&$("#browseralert").modal(),GV.toggleOverviewBtn(),initTableSorter(),$("[data-toggle='tooltip']").tooltip()}),$(document).on("click","td, .plot_btn",function(t){if($(this).hasClass("success")||$(this).hasClass("danger")){var a=$(this).attr("title"),e=a.replace(/[ \/]/g,"");GV.addData(this,e)}else $(this).hasClass("plot_btn")&&GV.addData(this,"all")});
