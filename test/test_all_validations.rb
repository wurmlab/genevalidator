  ...
  class ValidateOutput < Minitest::Test
    ...
    describe 'Protein dataset' do
      it 'xml and tabular inputs give the same output' do
        ...
        (GeneValidator::Validation.new(filename_prot_fasta, opts, 1, false, false)).run
        ...
        (GeneValidator::Validation.new(filename_prot_fasta, opts1, 1, false, false)).run
        $stdout.reopen original_stdout
    ...
    describe 'mRNA dataset' do
      it 'xml and tabular inputs give the same output' do
        ...
        (GeneValidator::Validation.new(filename_mrna_fasta, opts, 1, false, false)).run
        $stdout.reopen original_stdout
        ...
        (GeneValidator::Validation.new(filename_mrna_fasta, opts1, 1, false, false)).run
        $stdout.reopen original_stdout
